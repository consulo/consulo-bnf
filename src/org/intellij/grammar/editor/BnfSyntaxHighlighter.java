...
class BnfSyntaxHighlighter extends SyntaxHighlighterBase
{
	...
	public static final TextAttributesKey PIN_MARKER = createTextAttributesKey("BNF_PIN_MARKER", new TextAttributes(null, null,
			DefaultLanguageHighlighterColors.LINE_COMMENT.getDefaultAttributes().getForegroundColor(), EffectType.BOLD_DOTTED_LINE, 0));

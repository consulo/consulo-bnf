...
import static org.intellij.grammar.generator.ParserGeneratorUtil.getElementType;
...
public class RuleMethodsHelper
{
	...
	public RuleMethodsHelper(RuleGraphHelper ruleGraphHelper, ExpressionHelper expressionHelper, Map<String, String> simpleTokens)
	{
	...
	private String getRuleOrTokenNameForPsi(@NotNull PsiElement tree, @NotNull RuleGraphHelper.Cardinality type)
	{
		...
		else
		{
			...
			if(StringUtil.isEmpty(getElementType(asRule)))
			{
				return null;
			}
		}

...
public class KnownAttribute<T>
{
	...
	@Nullable
	public static KnownAttribute getAttribute(String name)
	{
		return ourAttributes.get(name);
	}
	...
	public static final KnownAttribute<String> ELEMENT_TYPE_HOLDER_CLASS = create(true, String.class, "elementTypeHolderClass",
	...
	public static final KnownAttribute<ListValue> IMPLEMENTS = create(false, ListValue.class, "implements", ListValue.singleValue(null,
	...
	public static KnownAttribute getCompatibleAttribute(String name)
	{
		...
		if(attr == null && "recoverUntil".equals(name))
		{
			return RECOVER_WHILE;
		}
		if(attr == null && "stubParserClass".equals(name))
		{
			return PARSER_UTIL_CLASS;
		}
		return attr;
	}
